        ...
        <section class="usp">
            <div class="container">
                <div class="section-header reveal">
                    <h2 class="section-title">Phong cách bánh tại <em>Lena</em></h2>
                    <p class="section-sub">Ba điều nhỏ nhưng quan trọng, làm nên khác biệt của từng hộp bánh.</p>
                </div>
                ...
                <div class="usp-list">
                    <div class="usp-item reveal">
                        ...
                        <div class="usp-desc">
                            ...
                            <p>Nói "không" hoàn toàn với hương liệu và màu nhân tạo.</p>
                        </div>
                    </div>
                    ...
                    <div class="usp-item reveal">
                        ...
                        <div class="usp-desc">
                            ...
                            <p>Cam kết không chất bảo quản, đóng hộp chỉn chu và giao ngay.</p>
                        </div>
                    </div>
                    ...
                    <div class="usp-item reveal">
                        ...
                        <div class="usp-desc">
                            ...
                            <p>Tan tan ngay đầu lưỡi, ăn một miếng là chỉ muốn ăn thêm.</p>
                        </div>
                    </div>
                </div>
            </div>
